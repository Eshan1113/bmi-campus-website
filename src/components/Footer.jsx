      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-16 pb-8 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
        ...
        <div className="space-y-6">
          <Link to="/" className="flex items-center gap-3">
            <img src="/logo.jpg" alt="BMI Campus Logo" className="h-12 w-auto brightness-110" />
        ...
        <div>
          ...
          <div className="space-y-3 text-sm">
            ...
            <Link to="/contact" className="flex items-center gap-2 hover:text-white transition-colors">
             ...
             <Link to="/student" className="flex items-center gap-2 hover:text-white transition-colors">
              <span className="text-accent">›</span> Student
            </Link>
          </div>
        ...
        {/* <div>
          ...
          <Link to="/student" className="inline-flex items-center gap-1.5 text-xs text-accent hover:underline mt-5">
